...
import { getmetalrateById,getBranchById,getallbranch, getbranchbyclient, updatemetalrate, createmetalrate, } from "../../../api/Endpoints"
...
const CreateMetalRate = () => {
  ...
  const validateForm = () => {
    const errors = {};
    if (formData.goldrate_18ct=== "") errors.goldrate_18ct = "Gold (18CT) Amount is required";
    if (formData.goldrate_20ct=== "") errors.goldrate_20ct = "Gold (20CT) Amount is required";
    if (formData.goldrate_22ct=== 0) errors.goldrate_22ct = "Gold (22CT) Amount is required";
    if (formData.goldrate_24ct=== "") errors.goldrate_24ct = "Gold (24CT) Amount is required";
    if (formData.goldcoin_1gm === "") errors.goldcoin_1gm = "Gold Coin Amount is required";
    if (formData.silverrate_1gm === 0) errors.silverrate_1gm = "Silver Amount is required";
    if (formData.diamond_1gm === "") errors.diamond_1gm = "Diamond Amount is required";
    if (formData.platinum_1gm === "") errors.platinum_1gm = "Platinum Amount is required";
