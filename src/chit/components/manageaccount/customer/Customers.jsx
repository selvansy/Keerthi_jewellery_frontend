    ...
    return (
        <div className='grid grid-rows-2 md:grid-cols-2 gap-2'>
            ...
            <div className='flex flex-col relative'>
                ...
                {/* Search Icon */}
                <div onClick={handleSearchmobile} className="absolute flex items-center justify-center cursor-pointer right-[0%] rounded-r-lg top-[68%] -translate-y-1/2 w-10 md:h-[40px] md:top-[42px] h-[20%] sm:right-0 sm:top-[68%] lg:right-[0%]"
