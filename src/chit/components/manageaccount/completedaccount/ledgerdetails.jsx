        ...
        <div className="bg-[#f5f5dc] mb-2 p-3">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                {ledgerData?.id_schme?.scheme_type === 1
                  ? "Amount End Weight"
                  : ledgerData?.id_schme?.scheme_type === 2
                  ? "Amount To Weight"
                  : ledgerData?.id_schme?.scheme_type === 3
                  ? "Weight"
                  : ledgerData?.id_schme?.scheme_type === 4
                  ? "Flexible Amount To Bonus"
                  : ledgerData?.id_schme?.scheme_type === 5
                  ? "Flexible Amount To Weight"
                  : ledgerData?.id_schme?.scheme_type === 6
                  ? "Fixed Amount To Weight"
                  : ledgerData?.id_schme?.scheme_type === 7
                  ? "Fixed Amount End Weight"
                  : ledgerData?.id_schme?.scheme_type === 8
                  ? "Fixed Amount To Bonus"
                  : ledgerData?.id_schme?.scheme_type === 9
                  ? "Flexible Amount End Weight"
                  : ledgerData?.id_schme?.scheme_type === 10
                  ? "Digi Gold"
                  : "Amount To Bonus"}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                {ledgerData?.classification_name || "N/A"}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                {(() => {
                  if (
                    ledgerData.scheme_type === 0 ||
                    ledgerData.scheme_type === 1 ||
                    ledgerData.scheme_type === 2
                  ) {
                    return `${ledgerData.scheme_name} ( Rs. ${ledgerData.amount} )`;
                  } else if (
                    ledgerData.scheme_type === 4 ||
                    ledgerData.scheme_type === 6 ||
                    ledgerData.scheme_type === 7 ||
                    ledgerData.scheme_type === 8 ||
                    ledgerData.scheme_type === 9 ||
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                {ledgerData?.scheme_acc_number || "N/A"}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                {ledgerData?.total_paidinstallments || "0"}
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm">
                Rs. {ledgerData?.total_paidamount || "0"}
              </p>
            </div>
