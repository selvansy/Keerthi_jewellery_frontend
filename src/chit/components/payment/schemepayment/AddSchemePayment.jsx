...
//       //   .max(
//       //     Yup.ref("total_installments"),
//       //     "Installments cannot be more than total installments"
//       //   ),
//     }),
...
//   useEffect(()=>{
//     if(formik.values.installments + Number(formik.values.total_installments) > Number(selectedScheme.total_installments)){
//       formik.setFieldError('installments',"Installments can't be greater than total installments")
//     }else{
...
const AddSchemePayment = () => {
  ...
  //     setBaseAmount(0);
  //   }else if (
  //     ([6,2,5].includes(selectedScheme.scheme_type) &&
  //     formik.values.metal_weight === "") ||
  //     formik.values.metal_weight === 0
  //   ) {
  //     console.log("first")
  //     const output = formik.values.payment_amount/metalRate
  //     formik.setFieldValue("metal_weight",output)
  //     formik.setFieldValue("payment_amount", "");
  //     setBaseAmount(0);
  //   }
  // }, [
