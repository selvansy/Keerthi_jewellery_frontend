...
const PendingDuePayment = () => {
  ...
  for (let i = 1; i <= totalPages; i++) {
    paginationButtons.push(
      <button
        ...
        className={`p-2 w-10 h-10 rounded-md ${currentPage === i ? ' text-white' : 'bg-gray-300 text-gray-400'}`}
  ...
  return (
    <div className="flex flex-col p-4">
      <h2 className="text-2xl text-gray-900 font-bold">Pending Due Payment</h2>
          ...
          <div className="p-3 space-y-4 flex-1 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="classification3">Classification 3</option>
              </select>
            </div>
...
export default PendingDuePayment;