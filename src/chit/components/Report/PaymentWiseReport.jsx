...
const PaymentWiseReport = () => {
  ...
  return (
    <div className="flex flex-col p-4">
      <h2 className="text-2xl text-gray-900 font-bold">Payment</h2>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-3 space-y-4 flex-1 overflow-y-auto">
            ...
            <label className='text-gray-700 mb-1 font-medium'>Date Range<span className='text-red-400'>*</span></label>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select className='appearance-none border-2 border-gray-300 rounded-md p-3 w-full bg-white pr-8 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent' defaultValue=''>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <div className="pointer-events-none absolute inset-y-0 right-3 flex items-center">
                  <svg className="h-4 w-4 text-gray-100" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" viewBox="0 0 24 24" stroke="black">
                    <path d="M19 9l-7 7-7-7"></path>
                  </svg>
                </div>
              </div>
