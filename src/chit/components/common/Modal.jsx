...
const Modal = () => {
            ...
            case "LEDGER_MODAL":
                    return (
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">{localFormData?.customer_name || 'N/A'}</p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">{localFormData?.scheme_typename || 'N/A'}</p>

                      </div>
             
                      <div className="space-y-1">
                        <p className="text-sm font-semibold text-gray-700">Classification</p>
                        <p className="text-sm">{localFormData?.classification_name || 'N/A'}</p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">
                        {(() => {
                            if (localFormData.scheme_type == 0 || localFormData.scheme_type == 1 || localFormData.scheme_type == 2) {
                            return localFormData.scheme_name + " ( Rs. " + localFormData.amount + ")";
                            } else if (localFormData.scheme_type == 4 || localFormData.scheme_type == 6 || localFormData.scheme_type == 7 || localFormData.scheme_type == 8 || localFormData.scheme_type == 9 || localFormData.scheme_type == 10) {
                            return localFormData.scheme_name + " ( Rs. " + localFormData.min_amount + ")" + " (" + localFormData.max_amount + ")";
                            } else if (localFormData.scheme_type == 3) {
                            return localFormData.scheme_name + " (" + localFormData.min_weight + ")" + " (" + localFormData.max_weight + ")";
                            } else {
                              return localFormData.scheme_name + " ( Rs. " + localFormData.payamount + ")";
                            }
                        })()}
                        </p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">{localFormData?.scheme_acc_number || 'N/A'}</p>
                      </div>
             
                      <div className="space-y-1">
                        <p className="text-sm font-semibold text-gray-700">Account Name</p>
                        <p className="text-sm">{localFormData?.account_name || 'N/A'}</p>
                      </div>
             
                      <div className="space-y-1">
                        <p className="text-sm font-semibold text-gray-700">Start Date</p>
                        <p className="text-sm">{localFormData?.start_date || 'N/A'}</p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">{localFormData?.total_installments || '0'}</p>
                      </div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-sm">Rs.  {localFormData?.total_paidamount || '0'}</p>
                      </div>
    ...
    return (
        <div className="fixed  inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-md lg:w-[650px]">
