...
export const addemployee = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/employee`,data);
    return response.data;
}
 

export const getallemployeetable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/employee/table`,data);
    return response.data;
}
 
export const changeEmployeeStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/employee/${id}/active`);
    return response.data;
}
...
export const deleteemployee = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/employee/${id}`);
    return response.data;
}
...
export const walletHistory = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/wallet/table`,data);
    return response.data;
}
...
export const changemetalstatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/metal/${id}/active`);
    return response.data;
}
...
export const getmetalById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/metal/${id}`);
    return response.data;
}
...
export const getallpuritytable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/purity/table`,data);
    return response.data;
}
...
export const changedisplaystatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/purity/${id}/display`);
    return response.data;
}
export const changepurityStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/purity/${id}/active`);
    return response.data;
}
export const addpurity = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/purity`, data);
    return response;
}
...
export const getpurityById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/purity/${id}`);
    return response.data;
}
...
export const getallpurity = async (id, data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/purity`, data);
    return response.data;
}
...
export const getconfigurationtable=  async(data)=>{
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/configuration/table`,data)
    return response.data
}

//add General
export const addgeneralsetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/generalsetting`,data);
    return response.data;
}
 
 
export const generalsettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/generalsetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const getConfig = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/notification-config`);
    return response.data;
}
...
export const addsmssetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/smssetting`,data);
    return response.data;
}
 
 
export const smssettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/smssetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
 
 //add Whatsapp
export const addwhatsappsetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/whatsappsetting`,data);
    return response.data;
}
 
export const whatsappsettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/whatsappsetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const addgatewaysetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/gatewaysetting`,data);
    return response.data;
}

export const gatewaysettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/gatewaysetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const adds3bucketsetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/bucketsetting`,data);
    return response.data;
}

export const s3bucketsettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/bucketsetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const addlayoutsetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/layoutsetting`,data);
    return response.data;
}

export const layoutsettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/layoutsetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const addappsetting = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/appsetting`,data);
    return response.data;
} 

 
export const appsettingprojectbranchbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/appsetting/project/${data.id_project}/branch/${data.id_branch}`);
    return response.data;
}
...
export const layouttype = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin//layouttype`);
    return response.data;
}
...
export const getallclassification = async (data)=>{
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/allclassification`,data)
    return response.data
}
...
export const getallgiftitemtable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftitem/table`,data);
    return response.data;
}

export const changegiftitemStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftitem/${id}/active`);
    return response.data;
}
...
export const deletegiftitem = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/giftitem/${id}`);
    return response.data;
}

export const getgiftitemById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftitem/${id}`);
    return response.data;
}

export const updategiftitem = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftitem/${id}`, data);
    return response;
}
...
export const changegiftvendorStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftvendor/${id}/active`);
    return response.data;
}
export const addgiftvendor = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftvendor`, data);
    return response;
}
export const deletegiftvendor = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/giftvendor/${id}`);
    return response.data;
}

export const getgiftvendorById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftvendor/${id}`);
    return response.data;
}

export const giftaccountcount = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftissues/cards`,data);
    return response.data;
}
...
export const updategiftvendor = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftvendor/${id}`, data);
    return response;
}

export const getallgiftvendor = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/getallgiftvendor`);
    return response.data;
}
...
export const getallgiftinwardtable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftinwards/table`,data);
    return response.data;
}

export const changegiftinwardStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftinwards/${id}/active`);
    return response.data;
}
export const addgiftinward = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftinwards`,data);
    return response;
}


export const updategiftinward = async (id,data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftinwards/${id}`, data);
    return response.data;
}
export const deletegiftinward = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/giftinwards/${id}`);
    return response.data;
}

export const getgiftinwardById = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftinwards/${data.id}`);
    return response.data;
}
...
export const giftissuesdatatable= async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftissues/table`,data);
    return response.data;
}

export const changegiftissuesStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftissues/${id}/active`);
    return response.data;
}
export const addgiftissues = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/giftissues`, data);
    return response;
}
export const deletegiftissues = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/giftissues/${id}`);
    return response.data;
}

export const getgiftissuesById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftissues/${id}`);
    return response.data;
}


export const getgiftissuesbranchById = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/branch/giftissues/${data}`);
    return response.data;
}


export const getgiftitemissuesById = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftissues/${data}`);
    return response.data;
}


export const updategiftissues = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/giftissues/${id}`, data);
    return response;
}

export const getallgiftissues = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/giftissues`);
    return response.data;
}
...
export const addschemepayment = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/payment`,data);
    return response.data;
}
 
export const updateschemepayment = async (data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/payment/${data.id}`,data);
    return response.data;
}
export const deleteschemepayment = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/payment/${id}`);
    return response.data;
}
export const getschemepaymentbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/payment/${data.id}`);
    return response.data;
}
...
export const getoffersTable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/offer/table`,data)
    return response.data
}
...
export const getnewarrivalsTable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/newarrivals/table`,data)
    return response.data
}
...
export const deletepushnotification= async(id)=>{
    const response= await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/pushnotificaiton/permenentdelete/${id}`)
    return response.data
}
...
export const createpushnotification= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/pushnotificaiton`,data)
    return response.data
}
...
export const getOutstandingSummaryReport = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/outstandingreport`,data);
    return response.data;
}
...
export const getallmenudatatable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/menusetting/allmenu`,data);
    return response.data;
}
 
export const changeMenuStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/menusetting/${id}/active`);
    return response.data;
}

export const addMenu = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/menusetting`, data);
    return response;
}
export const deleteMenu = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/menusetting/${id}`);
    return response.data;
}
 
export const getMenuById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/menusetting/${id}`);
    return response.data;
}
 
export const updateMenu = async (id,data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/menusetting/${id}`, data);
    return response;
}
 
export const getallmenu = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/menusetting`);
    return response.data;
}
...
export const getallsubmenudatatable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/submenusetting/submenu`,data);
    return response.data;
}
 
export const changesubmenuStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/submenusetting/${id}/active`);
    return response.data;
}
export const addsubmenu = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/submenusetting`, data);
    return response;
}
export const deletesubmenu = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/submenusetting/${id}`);
    return response.data;
}
 
export const getsubmenuById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/submenusetting/${id}`);
    return response.data;
}
...
export const getallsubmenu = async (id, data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/allsubmenusetting`, data);
    return response.data;
}
...
export const getallpaymentmodes = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/paymentmode/table`,data);
    return response.data;
}
 
export const changepaymentmodestatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/paymentmode/${id}/active`);
    return response.data;
}
export const addpaymentmode = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/paymentmode`, data);
    return response;
}
export const deletepaymentmode = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/paymentmode/${id}`);
    return response.data;
}
 
export const getpaymentmodebyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/paymentmode/${id}`);
    return response.data;
}
 
export const updatepaymentmode = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/paymentmode/${id}`, data);
    return response;
}
...
export const addstaff= async (data)=> {
 const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/staff`,data)
 return response.data
}

export const updatestaff = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/staff/${id}`, data);
    return response;
}
 
 
export const changeStaffUserStatus= async(id)=>{
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/staff/${id}/active`);
    return response.data
}
 
export const deleteStaffUser= async(id)=>{
    const response= await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/staff/${id}`);
    return response.data
}

export const getstaffbyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/staff/${id}`);
    return response.data;
}
...
export const getalluserroletable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/userrole/table`,data);
    return response.data;
}
 
export const changeuserrolestatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/userrole/${id}/active`);
    return response.data;
}
...
export const getuserroleById = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/userrole/${id}`);
    return response.data;
}
...
export const getalluserrole = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/userrole`);
    return response.data;
}
...
export const getschemetypetable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/schemetype/table`,data);
    return response.data;
}
 
export const changeschemetypestatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/schemetype/${id}/active`);
    return response.data;
}
export const addschemetype = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/schemetype`, data);
    return response;
}
export const deleteschemetype = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/schemetype/${id}`);
    return response.data;
}
 
export const getschemetypebyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/schemetype/${id}`);
    return response.data;
}
 
export const updateschemetype = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/schemetype/${id}`, data);
    return response;
}
 
export const getallschemetypes = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/schemetype`);
    return response.data;
}
...
export const getallclienttable = async () => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/client/table`);
    return response.data;
}
 
export const addclient = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/client`, data);
    return response.data;
}
...
export const updateclient = async (data) => {
    ...
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/admin/client/${data.id}`, data);
    return response.data;
}

export const deleteclient = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/admin/client/${id}`);
    return response.data;
}

export const getclientbyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/client/${id}`);
    return response.data;
}
...
export const getallprojecttable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/projects/table`,data)
    return response.data;
}

export const addproject = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/projects`, data);
    return response.data;
}
 
 
export const updateproject = async (id, data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/admin/projects/${id}`, data);
    return response.data;
}
 
export const changeprojectstatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/admin/projects/${id}/active`);
    return response.data;
} 
 
export const deleteproject = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/admin/projects/${id}`);
    return response.data;
} 

export const getprojectbyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/projects/${id}`);
    return response.data;
}
...
export const getallProject = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/projectdatatable`,data);
    return response.data;
}

export const getprojectbyclient = async(data)=>{
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/projects/client/${data.id_client}`)
    return response.data;
}
...
export const getallprojectaccesstable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess/table`,data)
    return response.data;
}

export const addprojectaccess = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess`, data);
    return response.data;
}
 
 
export const updateprojectaccess = async (data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess/${data._id}`, data);
    return response.data;
}
 
export const changeprojectaccessstatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess/${id}/active`);
    return response.data;
} 
 
export const deleteprojectaccess = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess/${id}`);
    return response.data;
} 

export const getprojectaccessbyid = async (id) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess/${id}`);
    return response.data;
}
 

export const getallprojectaccesss = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/projectaccess`,data);
    return response.data;
}


export const getprojectaccessbyclient = async(id)=>{
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/admin/projectaccessbyclient/${id}`)
    return response.data;
}

//Branch
export const getallbranchtable = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/branch/table`, data);
    return response.data;
}

export const addbranch = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/branch`, data);
    return response.data;
}
...
export const updatebranch = async ({ id, ...data }) => {
    try {
        const response = await axios.patch(`${import.meta.env.VITE_API_URL}/api/client/branch/${id}`, data);
        return response.data;
    } catch (error) {
...
export const getbranchbyclient = async (data)=>{
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/branch/client/${data.id_client}`)
    return response.data
}
...
export const deletebranch = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/branch/${id}`);
    return response.data;
}
 
export const activatebranch = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/branch/${id}/active`);
    return response.data;
}

export const getallbranch = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/branch`);
    return response.data;
}
...
export const employeebybranch= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/employeebybranch`,data);
    return response.data
}
...
export const getcustomertable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/customer/table`,data)
    return response.data
}

export const addcustomer = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/customer`,data);
    return response.data;
}
...
export const getcustomerbyid = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/customer/${data.id}`);
    return response.data;
}

export const getallcustomer = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/customer`);
    return response.data;
}
...
export const changeschemeaccountStatus = async (id) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/schemeaccount/${id}/active`);
    return response.data;
} 
export const updateschemeaccount = async (data) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/schemeaccount/${data.id}`,data);
    return response.data;
} 
export const deleteschemeaccount = async (id) => {
    const response = await Api.delete(`${import.meta.env.VITE_API_URL}/api/client/schemeaccount/${id}`);
    return response.data;
}
...
export const getemployeebybranch = async (data) => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/employee/branch/${data.id_branch}`);
    return response.data;
}
...
export const extendinstallment = async (data) => {
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/extendinstallment`,data);
    return response.data;
}
...
export const accountnotype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/accountnotype`);
    return response.data
}
export const classifytype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/classifytype`);
    return response.data
}
export const referralcalculation= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/referralcalculation`);
    return response.data
}
...
export const receipttype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/receipttype`);
    return response.data
}
export const closeprinttype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/closeprinttype`);
    return response.data
}
export const smsaccesstype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/smsaccesstype`);
    return response.data
}
export const whatsapptype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/whatsapptype`);
    return response.data
}
export const paymenttype= async()=>{
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/paymenttype`);
    return response.data
}
...
export const typeway = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/typeway`);
    return response.data;
}
...
export const allmakingcharge = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/allmakingcharge`);
    return response.data;
}
...
export const referralvisible = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/referralvisible`);
    return response.data;
}
export const allmetal = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/allmetal`);
    return response.data;
}
export const allpaymentmode = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/allpaymentmode`);
    return response.data;
}
export const allpaymentstatus = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/allpaymentstatus`);
    return response.data;
}
export const allschemestatus = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/schemestatus`);
    return response.data;
}
export const allpurity = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/allpurity`);
    return response.data;
}
export const gender = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/gender`);
    return response.data;
}
export const allcountry = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/country`);
    return response.data;
}
...
export const addedtype = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/addedtype`);
    return response.data;
}

export const giftissuetype = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/giftissuetype`);
    return response.data;
}
...
export const displayselltype = async () => {
    const response = await Api.get(`${import.meta.env.VITE_API_URL}/api/client/common/displayselltype`);
    return response.data;
}
...
export const getBranchByClient = async (data)=>{
    ...
    const response = await Api.post(`${import.meta.env.VITE_API_URL}/api/client/branch/client`,data)
    return response.data
}
...
export const createmetalrate= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/metalrate`,data)
    return response.data
}
 
export const updatemetalrate = async (values) => {
    const response = await Api.patch(`${import.meta.env.VITE_API_URL}/api/client/metalrate/${values.id}`,values.data);
    return response.data;
}

export const getmetalratetable= async(data)=>{
    const response= await Api.post(`${import.meta.env.VITE_API_URL}/api/client/metalrate/table`,data)
    return response.data
}

export const getmetalrateById= async(id)=>{  
    const response= await Api.get(`${import.meta.env.VITE_API_URL}/api/client/metalrate/${id}`)
    return response.data
}
